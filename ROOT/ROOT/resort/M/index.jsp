...
<link rel="apple-touch-icon-precomposed" href="image/image1/hotel.png" />
</head>
<body onload='ScreenShow(0);'>
<center>
	<div id="container" style="width:device-width;height:device-height scrolling=no;">
		<div id="header1" style="background-color:#00FFFF;height:35px;width:15%;float:left;" onclick='prevShow(0);'><center>
			<img src="image/image1/bback.png" width=40px height=32px></center></div>
		...
		<div id="header3" style="background-color:#00FFFF;height:35px;width:15%;float:left;" onclick='ScreenShow(0);'><center>
			<img src="image/image1/homme.png" width=40px height=32px></center></div>
		...
		호텔 소식
			<li onclick='ScreenShow(12);'>호텔소식</li>
			<br>
		</div>
		...
		<div id="s2" style="background-image:url(image/bg33.JPG);display:none;width=device-width">
			<center>
			<img src="image/image1/iii2.jpg" width=200px height=150px>
			<br>THE PRIVILEGE ROOM – AN IMPRESSIVE SETTING
			</center>		
		</div>
		<div id="s3" style="background-image:url(image/bg33.JPG);display:none;width=device-width">
			<center>
			<img src="image/image1/iiii2.jpg" width=200px height=150px>
			<br>THE CLASSIC ROOM – A BASE FOR WORK OR FUN
			</center>		
		</div>
		<div id="s4" style="background-image:url(image/bg33.JPG);display:none;width=device-width;height=device-height;">
				<div id="wrap"><iframe src="b_01.html"frameborder="0" border="0" bordercolor="white" width=450px height=500px marginwidth="0" marginheight="0" scroling="yes"></iframe></div>
		</div>
		...
		<div id="s12" style="background-image:url(image/bg33.JPG);display:none;">
			<div id="wrap"><iframe src="e01/e_01.jsp"  frameborder="0" border="0" bordercolor="white" width=320px height=420px marginwidth="0" marginheight="0" scroling="yes"></iframe></div>
		</div>
		...
		style="position:fixed;bottom:3px;position:fixed;left:1%;background-color:#FF0000;height:60px;width:18%;float:left;">
				<center>
				<img src= "image/image1/hotel.png" width=40px height=40px><br>
				<font size=2>호텔소개</font></center></div>
		<div id="m1" onclick='fncShow(1);' 
		style=" position:fixed;bottom:3px;position:fixed;left:21%;background-color:#FFFF00;height:60px;width:18%;float:left;">
				<center>
				<img src= "image/image1/search.png" width=40px height=40px><br>
				<font size=2>찾아오기</font></center></div>
		<div id="m2" onclick='fncShow(2);' 
		style=" position:fixed;bottom:3px;position:fixed;left:41%;background-color:#FFFF00;height:60px;width:18%;float:left;">
				<center>
				<img src= "image/image1/beach.png" width=40px height=40px><br>
				<font size=2>주변명소</font></center></div>
		<div id="m3" onclick='fncShow(3);' 
		style=" position:fixed;bottom:3px;position:fixed;left:61%;background-color:#FFFF00;height:60px;width:18%;float:left;">
				<center>
				<img src= "image/image1/book.png" width=40px height=40px><br>
				<font size=2>예약하기</font></center></div>
		<div id="m4" onclick='fncShow(4);' 
		style="position:fixed;bottom:3px;position:fixed;left:81%;background-color:#FFFF00;height:60px;width:18%;float:left;">
				<center>
