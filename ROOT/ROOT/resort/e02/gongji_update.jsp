...
<center>
<h1>수정할 내용을 입력해 주세요.[관리자페이지]</h1><br>
<%
	try{
		...
		ResultSet rset = stmt.executeQuery("select * from hugi where id="+id+";");
		rset.next();		
%>
...
<tr>
	...
	<td width = 440><textarea style ='width:500px; height:250px;' name= "content" maxlength=200 cols=70 row=600 ><%=rset.getString(4)%></textarea></td>
</tr>
<tr>
