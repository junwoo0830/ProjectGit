...
<%
	...
	if(loginOK!=null){
		if(loginOK.equals("yes"))
			out.println(" <h1>이용후기 게시판[관리자페이지]</h1><br> ");
	}
	else{
		out.println(" <h1>이용후기 게시판</h1><br> ");
	}
	try{
		...
		ResultSet rset = stmt.executeQuery("select *from hugi order by rootid desc, viewRank asc, id asc;");		
...
<%
	while(rset.next()){
		...
		"		<td width = 100><p align = center>"+rset.getString(3)+"</p></td>"+
		"	</tr>"
		);	
	}
%>
