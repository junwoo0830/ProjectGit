...
<tr><td>
	...
	<tr>
		<td width=100 height=100 ><a href="b_01.jsp"><h1>편도</h1></a></td>
		<td width=100 height=100 bgcolor=#ff6600><a href="b_02.jsp"><h1>왕복</h1></a></td>
		<input type="hidden" name="direction" value="goback">
	</tr>
	</table>
</td></tr>
<tr><td>
	<table border=0>
	<tr>
		<td width=100><p align=left>>구간 </p></td>
...
%>		
		...
		<td width=200><p align=left>오는날 : <input type=date name=destinationD max="<%=maxdate%>" min="<%=nowdate%>" value="<%=nowdate%>"</td>
	</tr>
	</table>
</td></tr>
<tr><td>
