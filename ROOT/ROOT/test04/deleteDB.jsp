...
<%
	...
	stmt.execute("delete from examtable where student="+stdID+";"
	);
	ResultSet rset = stmt.executeQuery(" select name, student, kor, eng,mat, (kor+eng+mat),floor((kor+eng+mat)/3) as ave from examtable order by ave desc");	
	out.println("<p><h1>레코드 삭제</h1></p>");
%>
