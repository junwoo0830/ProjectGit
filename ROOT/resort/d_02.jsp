...
<tr>
	...
	<td width=400><input type=text name="rName"  maxlength=17 value="" required></td>
</tr>	
<%
...
<tr>
	...
	<td width=400><input type=text name="address" size= 60 maxlength="50" value="" required></td>
</tr>	
<tr>
	<td width=150><p align=center>전화번호</p></td>
	<td width=400><input type=text name="phone" maxlength='11'  onkeyPress="if ((event.keyCode<48) || (event.keyCode>57)) event.returnValue=false;" value="" required></td>	
</tr>	
<tr>
	<td width=150><p align=center>입금자명</p></td>
	<td width=400><input type=text name="money" maxlength="17" value="" required></td>
</tr>
<tr>
	<td width=150><p align=center>남기실말</p></td>
	<td width=400><p align=left><textarea style ='width:350px; height:60px;' maxlength=200 name = "content" cols=70 row=600 ></textarea></p></td>
</tr>		
<tr>
